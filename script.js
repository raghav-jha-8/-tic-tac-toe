...
// Add this function to your JavaScript to resize the table based on the user selection
function adjustTableSize() {
    var table = document.getElementById("table_game");
    if (document.getElementById("r0").checked) {
        table.style.fontSize = "120px";
    } else {
        table.style.fontSize = "90px";
    }
}

// Add this line inside the getOptions() function after updating the player variable
adjustTableSize();
